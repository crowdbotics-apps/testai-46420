"""
Django settings for testai_46420 project.
...
ROOT_URLCONF = 'testai_46420.urls'
...
WSGI_APPLICATION = 'testai_46420.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testai_46420 API",
    "DESCRIPTION": "API documentation for testai_46420 App",
    "VERSION": "v1",
}
